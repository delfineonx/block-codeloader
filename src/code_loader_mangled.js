...
// EventManager
{
  ...
  _EM.i=()=>{
    ...
    let a=CF_.EVENT_REGISTRY,
    b=CF_.ACTIVE_EVENTS,
    c=CF_.event_manager,
    d=_EM.a=!!c.is_interruption_framework_enabled,
    e=c.default_retry_delay_ticks|0;
    e=e&~(e>>31);
    let f=c.default_retry_limit_ticks|0;
    f=(f&~(f>>31))+(-f>>31)+1;
    let g=_EM.d,
    h=_EM.e,
    i=_EM.f,
    ...
    for(let k of b){
      ...
      if(d&m){
        ...
        o|=0;
        let _IF=IF_;
        h[k]=g[k]=function(){_IF.state=0};
        globalThis[k]=function handler(arg0,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8){
          _IF.state=1;
          _IF.handler=handler;
          _IF.args=[arg0,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8];
          _IF.delay=n;
          _IF.limit=o;
          return h[k](arg0,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8)
        }
      }else{
        i[k]=1;
        h[k]=g[k]=N;
        globalThis[k]=function(arg0,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8){
          return h[k](arg0,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8)
        }
      }
    }
  ...
  _EM.j=()=>{
    ...
    while(I<c){
      ...
      Object.defineProperty(globalThis,d,{
        configurable:!0,
        set:fn=>{a[d]=[e,fn][+(typeof fn==="function")]}
      });
      I++
    }
    D=I>=c
...
// TickMultiplexer
{
  ...
  _TM.d=()=>{
    ...
    Object.defineProperty(globalThis,"tick",{
      configurable:!0,
      set:fn=>{M=[N,fn][+(typeof fn==="function")]}
    });
    let a=_EM.e;
    B=a.tick;
    a.tick=H;
  ...
  _TM.e=()=>{
    ...
    Object.defineProperty(globalThis,"tick",{
      configurable:!0,
      set:fn=>{a.tick=[N,fn][+(typeof fn==="function")]}
    });
    a.tick=M;
    B=N;
    _TM.a=N;
...
// JoinManager
{
  ...
  _JM.b=()=>{
    ...
    let a=CF_.join_manager;
    R=!!a.reset_on_reboot;
    Q=a.max_dequeue_per_tick|0;
    Q=(Q&~(Q>>31))+(-Q>>31)+1;
    M=_EM.d.onPlayerJoin;
    B=[];
    if(R|!J){
      J={}
    }
  ...
  _JM.d=()=>{
    ...
    _EM.e.onPlayerJoin=H;
    let a=_EM.d.onPlayerJoin;
    Object.defineProperty(globalThis,"onPlayerJoin",{
      configurable:!0,
      set:fn=>{M=[a,fn][+(typeof fn==="function")]}
    });
    I=!0
  };
  _JM.e=()=>{
    let a=Q;
    while(C<B.length&a>0){
      let b=B[C],
      c=b[0];
      if(J[c]!==P){
        M(c,b[1]);
  ...
  _JM.f=()=>{
    ...
    Object.defineProperty(globalThis,"onPlayerJoin",{
      configurable:!0,
      set:fn=>{b.onPlayerJoin=[a,fn][+(typeof fn==="function")]}
    });
    F=!0
  }
}
// BlockManager
{
  ...
  _BM.e=()=>{
    ...
    B=CF_.blocks.slice();
    let a=CF_.block_manager;
    C=!!a.default_locked_status;
    V=!!a.default_eval_status;
    N=a.max_registrations_per_tick|0;
    N=(N&~(N>>31))+(-N>>31)+1;
    T=a.max_requests_per_tick|0;
    T=(T&~(T>>31))+(-T>>31)+1;
    A=a.max_evals_per_tick|0;
    A=(A&~(A>>31))+(-A>>31)+1;
    O=a.max_errors_count|0;
    O=O&~(O>>31);
    _BM.b=0;
    K={};
    L={};
  ...
  const X=()=>{
    ...
    while(G<a&b>0){
      ...
      if(e){
        let f=api.isBlockInLoadedChunk(x,y,z),
        g=(x>>5)+"|"+(y>>5)+"|"+(z>>5);
        if(L[g]===void 0){
          L[g]=f<<1;
          if(!f){
            Q[Q.length]=[g,x>>5<<5,y>>5<<5,z>>5<<5]
          }
        }
        Y=1
      }
  ...
  const Z=()=>{
    ...
    while(b<a&c>0){
      let d=Q[b];
      if(api.getBlockId(d[1],d[2],d[3])===1){
        L[d[0]]=S
      }else{
        L[d[0]]=D;
        if(b===U){
    ...
    while(E<e&c>0){
      ...
      try{
        let g=api.getBlockData(x,y,z)?.persisted?.shared?.text;
        (0,eval)(g)
      }catch(h){
        let i=R.length-1,
        j=+(i<O);
        R[(i+1)*j]=[R[i*j],[x,y,z,h.name,h.message]][j]
      }
      c--;
      E++
    }
  ...
  _BM.f=P=>{
    ...
    y=P[1],
    z=P[2];
    if(K[(x|0)-(x<(x|0))+"|"+((y|0)-(y<(y|0)))+"|"+((z|0)-(z<(z|0)))]!==!1){
      return!_OM.c
    }
    return !1
  }
...
// BootManager
{
  ...
  T=-1;
  _OM.f=R=>{
    let a=_BM.c.length-1,
    b="Code Loader: BootManager: Code was loaded in "+(T*50)+" ms";
    if(a===0){
      b+=R?" with 0 errors.":".";
  ...
  _OM.g=()=>{
    ...
    b=a.length-1;
    if(b>0){
      let c="Code Loader: BlockManager: Code evaluation error"+(b===1?"":"s")+":",
      d=1;
      while(d<=b){
        let e=a[d];
  ...
  _OM.e=(W,R)=>{
    ...
    if(a.length){
      api.broadcastMessage([{
        str:"Code Loader: EventManager: Unregistered callbacks: "+a.join(", ")+".",
        style:_OM.d?.warning??{}
      }])
    }
    if(W){
  ...
  _OM.h=()=>{
    ...
    if(_OM.a<6){
      if(_OM.a===-2){
        if(_OM.b&!_EM.c&N>10){
          let a=_EM.b,
          b=`Code Loader: EventManager: ${a===null?"Undefined e":"E"}rror on events primary setup${a===null?".":` - ${a[0]}: ${a[1]}.`}`,
          c=api.getPlayerIds();
          for(let d of c){
            if(api.checkValid(d)){
              api.kickPlayer(d,b)
      ...
      if(_OM.a===0){
        N=0;
        let e=CF_.boot_manager;
        D=(e.boot_delay_ms|0)*.02|0;
        D=D&~(D>>31);
        L=!!e.show_load_time;
        E=!!e.show_errors;
        _OM.d={
          error:Object.assign({},CF_.LOG_STYLE.error),
          warning:Object.assign({},CF_.LOG_STYLE.warning),
          success:Object.assign({},CF_.LOG_STYLE.success)
        };
        T=-1;
        _EM.h=!1;
        _TM.b=!1;
...
// CodeLoader
{
  ...
  _BM=BM_,
  _OM=OM_;
  _CL.configuration=CF_;
  _CL.state=M=>{
    let T=_EM.f[M];
    if(T===void 0){
      api.broadcastMessage([{
        str:'Code Loader: EventManager: interruption state - "'+M+'" is invalid active event name.',
        style:_OM.d?.error??{}
      }])
    }else if(T===1){
      api.broadcastMessage([{
        str:'Code Loader: EventManager: interruption state - "'+M+'" interruption status is false.',
        style:_OM.d?.warning??{}
      }])
    }
    _IF.state=0
  ...
  _CL.isBlockLocked=P=>{
    return!Array.isArray(P)||P.length!==3||_BM.f(P)
  };
  _CL.reboot=()=>{
    if(!_OM.c){
      _EM.e.tick=_OM.h;
